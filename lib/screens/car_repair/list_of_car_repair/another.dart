...
import '../details_of_car_repair/another_details.dart';


class AnotherRepairScreen extends StatelessWidget {
  const AnotherRepairScreen({Key? key}) : super(key: key);
    ...
    return BlocConsumer<AppCubit,AppState>(
      ...
      builder: (context ,state) {
        return ConditionalBuilder(
          condition: AppCubit.get(context).getAnotherWorker != null,
          builder: (context) => Scaffold(
            ...
            body: Padding(
              ...
              child: ListView.separated(
                ...
                itemCount: AppCubit.get(context).getAnotherWorker!.worker!.length,
  ...
  child:Material(
    ...
    child: ListTile(
      onTap: (){
        ...
        Navigator.push(context , MaterialPageRoute(builder: (context) => AnotherCarRepairDetailsScreen(index))
        );
      },
      dense: true,
      leading: Stack(
      ...
      title: Text('${AppCubit.get(context).getAnotherWorker!.worker![index].name}',
        style: TextStyle(
            fontSize: 20,fontWeight: FontWeight.bold ,color:appPrimaryColor),
        overflow: TextOverflow.ellipsis,
        maxLines: 1,),
      subtitle: Text('another',style: TextStyle(fontSize: 15)),
